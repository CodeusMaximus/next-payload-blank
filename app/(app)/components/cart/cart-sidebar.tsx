'use client'
// components/cart/cart-sidebar.tsx (with glassmorphism)
...
export default function CartSidebar() {
  const { items, isOpen, closeCart, updateQuantity, removeItem, totalPrice, itemCount } = useCart()
          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-4">
              {items.map((item) => (
                <div 
                  key={item.id} 
                  className="flex items-center gap-4 p-4 rounded-xl transition-all duration-200 hover:bg-white/10 dark:hover:bg-black/10"
                  style={{
